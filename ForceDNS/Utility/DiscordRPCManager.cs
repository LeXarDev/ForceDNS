...
namespace ForceDNS.Utility
{
    public class DiscordRPCManager
    {
        ...
        public void UpdatePresence(string details = "ForceDNS", string state = "Ideal", string smallImage = "None", string smallImageText = "None", string largeImage = "ForceDNS", string largeImageText = "Powerful DnsChanger")
        {
            var presence = new RichPresence
            {
                Details = details,
